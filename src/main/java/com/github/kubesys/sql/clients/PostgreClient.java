...
public class PostgreClient extends KubeSQLClient {
	...
	public static final String CREATE_POSTGRE_TABLE = "CREATE TABLE #TABLE# (name varchar(512), namespace varchar(128), time int8,"
	...
	public static final String DEF_POSTGRE_URL = "jdbc:postgresql://kube-database.kube-system:5432/postgres"
																...
																+ "&socketTimeout=06000&tcpKeepAlive=true&&serverTimezone=Asia/Shanghai";
