 ...
 *
 */
public class CreateMysqlTableBuilderTest {

	@SuppressWarnings("unchecked")
	public static void main(String[] args) throws Exception {
		CreateTableBuilder<?, CreateTable> tableBuilder = (CreateTableBuilder<?, CreateTable>) Class.forName(CreateMysqlTableBuilder.class.getName()).newInstance();
